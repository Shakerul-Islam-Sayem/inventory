...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="mb-3 text-center text-decoration-underline fw-bolder">Product Outward</h2>
                        ...
                        <table class="table table-responsive table-striped">
                            ...
                            <tbody id="optionSetContainer">
                                <tr id="optionSet" class="option-row">
                                    ...
                                    <td>
                                        <input class="form-control sale-price" type="number" name="sale_price[]"
